...
export default {
  setup() {
    ...
    const cardList = ref([
      ...
      { name: "Show Home Empty Element", path: "/template/home/empty" },
      { name: "Show Home Login Element", path: "/template/home/login" },
      { name: "Show Home Admin Element", path: "/template/home/admin" },
      { name: "Show Chat Drawer Element", path: "/template/chat/drawer" },
      { name: "Show Chat Prompt Element", path: "/template/chat/prompt" },
      { name: "Show Chat Marked Element", path: "/template/chat/chat" },
    ]);
